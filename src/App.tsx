  ...
  return (
    <div>
      <div className="navbar bg-base-100">
        <h1 className="text-4xl font-bold">💊 家庭用药指南</h1>
      </div>
      <div className="text-2xl text-center m-4">药物</div>
      <div className="overflow-x-auto m-2">
        <table className="w-full table border-separate border-spacing-0 border border-slate-500">
          <thead>
            <tr>
      ...
      <div className="overflow-x-auto m-2">
        ...
        <p>
          *吃药前仔细看说明书，包括：适应症、禁忌症、不良反应、药物冲突、用法用量、注意事项。
        </p>
        <p>
          *功能相同、成分相同、作用机制相同的药物不能混服。如：泰诺、布洛芬。
        </p>
      </div>
      ...
      <div className="overflow-x-auto m-2">
        <table className="table w-full table-compact border-separate border-spacing-0 border border-slate-500">
          ...
          <tbody>
            <tr>
              <th className="border border-slate-600 text-center" rowSpan={2}>
                发烧
              </th>
              <td className="border border-slate-600 text-center">
                对乙酰氨基酚
            ...
            <tr>
              ...
              {/*<td className="border border-slate-600 text-center">❌ 不建议用</td>*/}
              <td className="border border-slate-600 text-center" rowSpan={8}>
                🥼 慎用，遵医嘱
              </td>
            </tr>
            <tr>
              <th className="border border-slate-600 text-center" rowSpan={4}>
                流鼻涕*
              </th>
            ...
            <tr>
              <th className="border border-slate-600 text-center" rowSpan={3}>
                鼻塞*
              </th>
            ...
            <tr>
              ...
              <td className="border border-slate-600 text-center" colSpan={5}>
                呼吸道感染导致的咳痰症状，通常不建议使用药物祛痰。但如有大量脓痰，堵塞较严重，咳痰超过2周症状未改善或有其他异常，建议前往医院就诊。
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div className="overflow-x-auto m-2">
        <p>
          *鼻塞流鼻涕建议：低龄儿童使用生理盐水鼻喷剂/生理盐水滴鼻剂/吸鼻器；能配合的儿童使用洗鼻壶和洗鼻盐。
        </p>
        ...
        <table className="table w-full table-compact border-separate border-spacing-0 border border-slate-500">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-slate-600 text-center" rowSpan={4}>
                ✅ 可以使用
              </td>
              <td className="border border-slate-600 text-center">
                ✅ 可以使用
            ...
            <tr>
              ...
              <td className="border border-slate-600 text-center" rowSpan={3}>
                🥼 慎用，遵医嘱
              </td>
              <td className="border border-slate-600 text-center">
                🥼 慎用，遵医嘱
      ...
      <div className="overflow-x-auto m-2">
        ...
        <p>
          **怀孕或哺乳期感冒用药需要权衡利弊，本表仅供参考，建议遵医嘱和药师。
        </p>
      </div>
        ...
        <table className="table w-full table-compact border-separate border-spacing-0 border border-slate-500">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-slate-600 text-center" rowSpan={12}>
                🥼 慎用，遵医嘱
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th className="border border-slate-600 text-center">干咳</th>
              <td className="border border-slate-600 text-center">右美沙芬</td>
              <td className="border border-slate-600 text-center" colSpan={2}>
                仅限剧烈咳嗷影响生活时，不超过7天
              </td>
      ...
      <div className="overflow-x-auto m-2">
        ...
        <p>
          **其他基础疾病（如：心脏病、肠胃道疾病、甲状腺疾病、神经系统疾病）阅读说明书或遵医嘱和药师。
        </p>
      </div>
      <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
        ...
        <nav className="grid grid-flow-col gap-4">
          <a
            ...
            href="https://github.com/zcyc/medication-guide"
            target="_blank"
          >
            查看源码
          </a>
          <a
            className="link link-hover"
            href="https://github.com/zcyc/medication-guide/issues"
            target="_blank"
          >
            反馈错误
          </a>
        ...
        <aside>
          <p>
            ...
            <a href="https://github.com/zcyc">Charles</a> &{" "}
            <a href="https://github.com/jerryshell">Jerry</a>{" "}
          </p>
        </aside>
      </footer>
    </div>
